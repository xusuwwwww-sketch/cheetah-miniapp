    ...
    <scroll-view scroll-y class="content" v-if="detail">
      ...
      <view class="info-card">
        ...
        <view class="info-row" v-if="detail.signup_deadline">
          <image class="detail-icon" src="data:image/svg+xml;base64," mode="aspectFit" />
